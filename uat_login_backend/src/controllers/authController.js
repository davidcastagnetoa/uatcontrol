...
// Esta funcion recibe el usuario y contraseña del la funcion login del cliente, en AuthProvider.js, y si son correctos genera y devuelve un token. Si no son correctos devuelve un 401.
...
//Esta funcion verifica el token recibido por el cliente desde AuthProvider.js en el header de la peticion, y si es valido devuelve el usuario y el token. Si no es valido devuelve un 401.
